...
import { exportRoomKeysToDownload, importRoomKeysWithStatus } from './roomKeyTransfer';

type KeyTransferSettingsSectionProps = {
  draft: MatrixConfig;
  onImportRoomKeys: (
    value: MatrixConfig,
...
export function KeyTransferSettingsSection({
  draft,
  onImportRoomKeys,
  onExportRoomKeys,
  onConnect,
}: KeyTransferSettingsSectionProps) {
